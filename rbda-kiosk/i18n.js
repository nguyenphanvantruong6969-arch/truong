...
(function (global) {
  ...
  const UI_STRINGS = {
    vi: {
      ...
      import_hint: "Kéo thả file CSV vào ô dưới — phần mềm tự biết đó là danh sách CLB, file chọn CLB muốn thi hay file xếp hạng nguyện vọng. Thả được nhiều file một lúc, và tự nhập theo đúng thứ tự.",
      drop_zone_main: "Kéo file CSV vào đây",
      drop_zone_sub: "hoặc bấm để chọn file — có thể chọn nhiều file",
      ...
      queue_ambiguous: "Chưa chắc đây là file gì — bộ cột này hợp với cả hai loại. Chọn giúp ở ô bên phải.",
      queue_unknown: "Không nhận ra định dạng. Xem mau_csv/HUONG_DAN_CSV.md để biết các cột phần mềm đọc được.",
      queue_pick_kind: "— chọn loại file —",
      ...
      feedback_import_done: "Đã nhập xong {n} file",
    ...
    en: {
      ...
      import_hint: "Drop CSV files below — the app works out whether each one is a club list, a club-test selection, or ranked preferences. Drop several at once; they are imported in the right order.",
      drop_zone_main: "Drop CSV files here",
      drop_zone_sub: "or click to choose files — you can pick several",
